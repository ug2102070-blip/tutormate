      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-white">My Notifications</h1>
      ...
      {loading ? (
        ...
        >
          <div className="w-16 h-16 rounded-2xl flex items-center justify-center text-3xl"
            style={{ background: "var(--color-bg-secondary)" }}>🔔</div>
          <div className="text-center">
            <p className="font-bold" style={{ color: "var(--color-text)" }}>No notifications yet</p>
            <p className="text-sm mt-1" style={{ color: "var(--color-text-muted)" }}>
              Your tutor will send updates about assignments, exams, and materials here.
            </p>
          </div>
        </div>
      ) : (
            ...
            <div key={dateLabel}>
              <div className="flex items-center gap-3 mb-2">
                <span className="text-xs font-bold uppercase tracking-widest"
                  style={{ color: "var(--color-text-muted)" }}>{dateLabel}</span>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-2">
                        <div>
                          <span className="text-xs font-bold uppercase tracking-wide px-1.5 py-0.5 rounded-md mr-2"
                            style={{ background: "var(--color-primary-50)", color: "var(--color-primary)" }}>
                            {TYPE_LABELS[n.type] ?? n.type}
                          </span>
                          <p className="text-sm font-semibold mt-1"
                            style={{ color: "var(--color-text)" }}>{n.title}</p>
                        </div>
                        {!n.isRead && (
