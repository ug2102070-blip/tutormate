...
export default function CoachingCenterPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 p-4 md:p-6">
      ...
      {/* ── OWNER PORTAL BANNER ─ shows only if this tutor is the center owner ── */}
      {isOwner && (
        <div
          className="rounded-2xl p-4 flex flex-col sm:flex-row sm:items-center gap-3 justify-between"
          style={{
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-bold" style={{ color: "var(--color-text-primary)" }}>
                You have access to the Owner Portal
              </p>
              <p className="text-xs mt-0.5" style={{ color: "var(--color-text-muted)" }}>
                View center analytics, manage all tutors, fee reports & more.
              </p>
            </div>
          </div>
          <Link
